...
2. **Stripe dashboard/events** — for anything payment-shaped. Distinguish explicitly: _declined / insufficient funds / bank-verification abandoned_ (NOT bugs — normal outcomes) versus _integration or webhook errors_ (bugs). Say which, plainly.
