...
- Payments: Stripe **test mode only**, standard test cards. Assert the outcome the user sees _and_ the record that should exist (test-mode dashboard/webhook effect on non-production data).
