...
| `/compass-and-path` | The Compass & The Path *(label pending sign-off; may display as "Practice")* | ✅ Full copy | Framework deep-dive: 4-Element Compass, 4-Step Path, three tools band |
