...
- [ ] **You:** copy this folder into the project repo per the copy map in `00-START-HERE.md` (or simply tell Claude Code: _"Install the testing setup from docs/testing-setup — follow its 00-START-HERE copy map"_).
