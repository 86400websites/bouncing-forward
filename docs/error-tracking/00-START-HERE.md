...
Read `ERROR-TRACKING-GUIDE.md` once (10 minutes). Then run `SETUP-CHECKLIST.md` — it ends with a deliberate test error so you _see_ the alert arrive before you ever need it for real.
