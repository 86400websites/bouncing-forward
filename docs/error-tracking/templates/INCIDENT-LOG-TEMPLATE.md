...
| --- | ------ | ------------------------------------ | ---------------------------------------------------------------------------------- | ------------------------ | --------- | ---------- | ---------------------- | ------------------ | ----------------------- | --------------- |
| 001 | [DATE] | [User report]                        | [e.g. Password reset email linked to the wrong address, so resets never completed] | [1 member — a.**@**.com] | [Blocker] | [Bug]      | [PR #__]               | [AC-003b]          | [✓ DATE / n/a — reason] | [Closed]        |
