...
How to hand Bouncing Forward over to [CLIENT_NAME] (or an incoming team) so they own everything,
...
| Hosting — Vercel / the bouncing-forward Vercel project |         | [CLIENT_NAME]       | Provider transfer/invite flow                            |
| Domain registrar — bouncing-forward.com                |         | [CLIENT_NAME]       | Registrar's own transfer flow (domain = client property) |
