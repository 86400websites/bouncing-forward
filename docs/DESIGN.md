...
The taste contract for Bouncing Forward: how the approved predevelopment design decisions become code.
`docs/TECH-ARCHITECTURE.md` fixes the _mechanics_; this file fixes the _taste_. Fill the tables from the
