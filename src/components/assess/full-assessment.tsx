...
const QUESTIONS: Question[] = [
  ...
  { part: "walk", key: "Accept", text: "I’ve stopped spending my energy fighting the fact that it happened." },
  { part: "walk", key: "Accept", text: "I spend less time in the what-ifs than I used to." },
  { part: "walk", key: "Reflect", text: "I can see what has carried me through hard things before." },
  { part: "walk", key: "Reflect", text: "I can think about what this setback means for me without needing to distract myself." },
  { part: "walk", key: "Reflect", text: "I know who was there when I came through before — and what that tells me." },
  { part: "walk", key: "Imagine", text: "I can picture one believable next chapter, even faintly." },
  { part: "walk", key: "Imagine", text: "What I want next is connected to the people and things that matter most to me." },
  { part: "walk", key: "Imagine", text: "Planning forward feels like honouring what changed, not betraying it." },
  ...
  { part: "walk", key: "Act", text: "When the plan breaks, I stay committed to the purpose." },
  { part: "carry", key: "Resilience", text: "When things knock me down, I find my way back to my feet." },
  { part: "carry", key: "Resilience", text: "I can admit when I’m not fine, instead of performing being fine." },
  { part: "carry", key: "Resilience", text: "When I doubt myself, I remember the hard things I have already come through." },
  { part: "carry", key: "Adaptability", text: "When life stops following the plan, I can adjust." },
  { part: "carry", key: "Adaptability", text: "I’m letting my sense of who I am shift, rather than forcing the old shape to fit." },
  { part: "carry", key: "Adaptability", text: "I’ve kept at least one new door open that wasn’t open before." },
  { part: "carry", key: "Optimism", text: "I can imagine good things still ahead for me." },
  { part: "carry", key: "Optimism", text: "I can separate how I feel today from the story of my whole life." },
  { part: "carry", key: "Optimism", text: "I hold a quiet belief that something good can still come from this." },
  { part: "carry", key: "Support", text: "There are people I can lean on — and I let myself lean." },
  { part: "carry", key: "Support", text: "I can say what I actually need, instead of hoping people will guess." },
  { part: "carry", key: "Support", text: "I let myself receive care as readily as I give it." },
];
...
const REPORTS: Record<Key, { is: string; bright: Report; flickering: Report; faint: Report }> = {
  Resilience: {
    is: RECOG.Resilience,
    bright: { state: "a real strength", read: "Hard days pass, and you keep finding your feet. What you are doing is working.", tend: "Before you say you’re fine, keep checking whether you are." },
    flickering: { state: "gathering strength", read: "Some days you find your footing, some days you don’t. That is what carrying real weight looks like - not failure.", tend: "One small routine, kept daily. Rhythm rebuilds more than willpower." },
    faint: { state: "needs strengthening", read: "Getting up is taking everything you have right now. That is the weight of the setback, not a failure.", tend: "One small kept promise a day - and let one person see how heavy it is." },
  },
  Adaptability: {
    is: RECOG.Adaptability,
    bright: { state: "a real strength", read: "You are bending without breaking - letting the picture of your future update.", tend: "Keep one new door open - a conversation, a direction, a person." },
    flickering: { state: "gathering strength", read: "Part of you is adjusting; part is still rebuilding what was. That is loyalty, not stubbornness.", tend: "Change one small thing on purpose this week." },
    faint: { state: "needs strengthening", read: "The new shape of life still feels wrong to the touch. Your adapting will take as long as it takes.", tend: "Ask: what from before still fits who I am now?" },
  },
  Optimism: {
    is: RECOG.Optimism,
    bright: { state: "a real strength", read: "You can separate how today feels from the story of your whole life. Keep practising it.", tend: "One observation a day: what, today, quietly went well?" },
    flickering: { state: "gathering strength", read: "Some days the road is visible; some days it closes over. The work is simply not to close the door.", tend: "Borrow a living example - someone who has carried this and come through." },
    faint: { state: "needs strengthening", read: "The future is hard to picture right now. That is the setback’s doing, not yours.", tend: "Once a day, name one small thing that still worked." },
  },
  Support: {
    is: RECOG.Support,
    bright: { state: "a real strength", read: "Care is flowing both ways. You are carrying this as a shared weight, not a private one.", tend: "Thank one person whose support has carried you: what you did mattered." },
    flickering: { state: "gathering strength", read: "You have people - and you are half letting them in. Your weight is not too heavy to share.", tend: "Tell one person what you actually need this week." },
    faint: { state: "needs strengthening", read: "You may be carrying this far more alone than you need to.", tend: "One message to one person - just to not be alone in it." },
  },
  Accept: {
    is: "An honest look at where you’re standing. Not where you were. Not where you think you should be by now.",
    bright: { state: "steady underfoot", read: "You can look at what happened without turning away - and spend your energy on what begins from here.", tend: "One true sentence a day: this happened, and it is part of my life now." },
    flickering: { state: "partly taken", read: "Most days you can look at it; some days the what-ifs pull you back.", tend: "Swap the question: not “why did this happen?” but “who am I, going forward?”" },
    faint: { state: "still ahead", read: "Part of you hasn’t yet let it land. That is often a form of love, not a problem to solve.", tend: "Once a day, say one true thing about what happened - no comfort after it." },
  },
  Reflect: {
    is: "You have come through hard things before. Look at how - and at who was there when you did.",
    bright: { state: "steady underfoot", read: "You can sit with what happened and ask the question that gives it direction: what does this ask of me?", tend: "Keep a weekly pause: what happened, what carried me, what next?" },
    flickering: { state: "partly taken", read: "You reflect - and sometimes you circle the same place without arriving.", tend: "At day’s end: what did I feel today that I didn’t say out loud? Write it down." },
    faint: { state: "still ahead", read: "Stillness feels threatening right now - but what we avoid, we cannot use.", tend: "Five minutes, once this week: sit, and name what you meet." },
  },
  Imagine: {
    is: "Not the perfect future. One believable one.",
    bright: { state: "steady underfoot", read: "You can hold a direction - and your goals carry faces, not just ambitions.", tend: "Every so often, ask: does this still honour the reason I began?" },
    flickering: { state: "partly taken", read: "A next chapter appears and disappears. Planning forward isn’t betrayal - it is what the change makes room for.", tend: "Write one sentence: something you want to be different in six months." },
    faint: { state: "still ahead", read: "The future feels far away right now. Don’t reach for the horizon yet - reach for a direction.", tend: "Name the smallest true want: one call, one conversation, one walk." },
  },
  Act: {
    is: "Small enough to do today. Real enough to count.",
    bright: { state: "steady underfoot", read: "You are moving - beginning before you feel ready, adjusting as you go. Momentum is made, not waited for.", tend: "Mark the milestones no one else can see." },
    flickering: { state: "partly taken", read: "You move in bursts, then stall. Every so often, stop and ask: what is this for?", tend: "When you stall, do the next smallest thing - this hour, not tomorrow." },
    faint: { state: "still ahead", read: "You may be waiting to feel ready - readiness rarely arrives on its own. Ask: is this rest, or is it frozen?", tend: "One small thing today. Not a plan - a movement." },
  },
};

const PATH_STAND: Record<PathKey | "motion", string> = {
  Accept: "The honest look comes first - and being here says you’re ready to take it.",
  Reflect: "You’ve let the truth land. Now look at what has carried you this far.",
  Imagine: "You’ve done the honest looking. Now picture one believable next chapter, even faintly.",
...
function compassSVG(avgs: Record<string, number>): string {
  const cx = 300, cy = 222, R = 132;
  const reach = (b: Band) => (b === "bright" ? 112 : b === "flickering" ? 78 : 46);
  const dirs: Record<CompassKey, [number, number, string, number, number, number]> = {
  ...
  for (let a = 0; a < 360; a += 15) {
    const rad = (a * Math.PI) / 180, long = a % 90 === 0;
    const r1 = R - (long ? 16 : 8), r2 = R - 1;
  ...
  for (const k of COMPASS_KEYS) {
    const d = dirs[k];
    const anchor = d[2], lx = d[3], ly = d[4], sy = d[5];
    const b = band(avgs[k]);
...
function waypoint(x: number, y: number, k: string, state: "here" | "behind" | "ahead", labelSide?: "right"): string {
  let m = "";
  if (state === "here") {
    m += `
  ...
  if (state === "here") {
    lx = x; anchor = "middle"; ly1 = y + 34; ly2 = y + 50;
  } else if (labelSide === "right") {
    lx = x + 18; anchor = "start"; ly1 = y - 4; ly2 = y + 15;
  } else {
    lx = x; anchor = "middle"; ly1 = y + 26; ly2 = y + 42;
  }
  m += `
...
function mapSVG(step: PathKey | "motion"): string {
  ...
  const pts: Record<PathKey, [number, number]> = { Accept: [120, 226], Reflect: [290, 152], Imagine: [455, 218], Act: [605, 124] };
...
function mapSVGMobile(step: PathKey | "motion"): string {
  const stepIndex = step === "motion" ? 4 : PATH_KEYS.indexOf(step);
  const pts: Record<PathKey, [number, number]> = { Accept: [76, 86], Reflect: [204, 206], Imagine: [76, 326], Act: [204, 446] };
  const route = `
...
/* ---------------- report block ---------------- */
function ReportBlock({ k, isPath, answers }: { k: Key; isPath: boolean; answers: number[] }) {
    ...
    <div className="rounded-lg border border-border bg-card p-6 sm:p-7">
      <div className="flex items-start justify-between gap-4">
        <h4 className="text-lg font-bold leading-snug">
          ...
          <span className="whitespace-nowrap text-sm font-semibold text-brand-accent-text">
            · {isPath ? `${k} · ` : ""}{R.state}
          </span>
        </h4>
      ...
      <p className="mt-2 text-sm italic text-muted-foreground">{REPORTS[k].is}</p>
      <div
...
export function FullAssessment() {
  const [phase, setPhase] = useState<"intro" | "part" | "questions" | "gate" | "results">("intro");
  ...
  function startOver() {
    if (answers.length === 0 || window.confirm("Start again from the beginning? Your answers so far will be cleared.")) {
      setAnswers([]);
      setPhase("intro");
    }
  }
    ...
    return (
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-4 text-lg leading-relaxed">
          No right answers, no score - just the clearest view of where you stand.
        </p>
        <p className="mt-4 border-l-[3px] border-brand-accent pl-4 text-lg leading-relaxed">
    ...
    return (
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-4 text-xs font-bold uppercase tracking-[0.12em] text-muted-foreground">
          {q.part === "walk" ? (
            <>
              <span className="text-brand-accent-text">{PATH_Q[q.key as PathKey]}</span> ·{" "}
            </>
          ) : null}
          {idx + 1} of {QUESTIONS.length}
        </p>
        <p className="mt-3 text-2xl font-bold leading-snug text-primary sm:text-3xl">“{q.text}”</p>
        {idx === 0 ? (
        ...
        <div className="mt-8 flex flex-wrap gap-x-6 gap-y-2 text-sm italic text-muted-foreground">
          {idx > 0 ? (
            <button type="button" onClick={goBack} className="underline underline-offset-4 hover:text-foreground">
              ← Change my previous answer
            </button>
          ) : null}
          <button type="button" onClick={startOver} className="underline underline-offset-4 hover:text-foreground">
  ...
  if (phase === "gate") {
    return (
      <div className="mx-auto max-w-2xl">
        ...
        <form onSubmit={unlock} className="mt-7 flex max-w-md flex-col gap-3 sm:flex-row">
          ...
          <input
            ...
            className="w-full flex-1 rounded-full border border-border bg-card px-5 py-3 text-base outline-none transition-colors focus-visible:border-brand-accent focus-visible:ring-2 focus-visible:ring-brand-accent/30"
          />
          <button
            type="submit"
            className="inline-flex items-center justify-center rounded-full bg-primary px-7 py-3 font-[family-name:var(--font-display)] text-sm font-bold text-primary-foreground transition-colors hover:bg-brand-primary-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
          >
            Open everything →
          </button>
        </form>
  ...
  [...COMPASS_KEYS, ...PATH_KEYS].forEach((k) => (avgs[k] = avgFor(k, answers)));
  ...
  const step: PathKey | "motion" = PATH_KEYS.find((k) => avgs[k] <= 3) || "motion";
  const pathHeading = step === "motion" ? "You’re in motion." : `You’re standing at “${PATH_Q[step]}”.`;
  ...
  return (
    <div className="mx-auto max-w-3xl" style={scopeStyle}>
      ...
      {justUnlocked ? (
        <div className="mb-8 rounded-lg border-2 border-brand-accent bg-card p-5">
      ...
      <div className="mt-8 rounded-lg border border-border bg-card p-6 sm:p-8">
        ...
        <div className="fa-map-d mt-4" dangerouslySetInnerHTML={{ __html: mapSVG(step) }} />
        <div className="fa-map-m mt-4" dangerouslySetInnerHTML={{ __html: mapSVGMobile(step) }} />
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          The trail runs through the four questions - the pin marks where you’re standing.
        </p>
      ...
      {/* The Path */}
      <p className="mt-10 text-xs font-bold uppercase tracking-[0.08em] text-brand-accent-text">The Path</p>
      <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
      ...
      {/* The Compass */}
      <p className="mt-10 text-xs font-bold uppercase tracking-[0.08em] text-brand-accent-text">The Compass</p>
      <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
        Four strengths, one name - your Compass. The further a point reaches,
        the more firmly that strength is standing.
      </p>
      <div className="mt-4" dangerouslySetInnerHTML={{ __html: compassSVG(avgs) }} />
      <div className="mt-4 space-y-4">
        {COMPASS_KEYS.map((k) => (
      ...
      {/* What to do next */}
      <p className="mt-10 text-xs font-bold uppercase tracking-[0.08em] text-brand-accent-text">What to do next</p>
      <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          ...
          <div className="mt-3 space-y-3">
            {PATH_KEYS.map((k) => (
              <div key={k} className="flex items-start gap-3">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={ICONS[k]} alt="" className="size-9 shrink-0 rounded" />
                <p className="leading-relaxed">
                  <span className="font-bold">{k}</span>{" "}
                  <span className="text-muted-foreground">{REPORTS[k][band(avgFor(k, answers))].tend}</span>
                </p>
              </div>
            ))}
          </div>
      ...
      <p className="mt-10 text-center font-[family-name:var(--font-display)] font-bold text-primary">
      ...
      <div className="fa-noprint mt-8 text-center">
        <a
          href="#library"
          className="inline-flex items-center rounded-full bg-brand-accent px-8 py-4 font-[family-name:var(--font-display)] text-base font-bold text-primary shadow-sm transition-[filter] hover:brightness-95 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
        >
          Your All In library is open — download everything ↓
        </a>
      </div>

      <div className="fa-noprint mt-8 flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm italic text-muted-foreground">
        <button type="button" onClick={() => window.print()} className="underline underline-offset-4 hover:text-foreground">
